...
const TarjetaAnuncio = ({ id, titulo, tipo, subtitulo, prioridad, estado, onEditar, onEliminar, onAbrirDocumento }) => {
  ...
  return (
    <div className={styles.announcementCard}>
      ...
      >
        ...
        {!archivos.imagenUrl && (
          <span className={styles.cardThumbnailLabel}>{titulo}</span>
        )}
      </div>
      ...
      <div className={styles.cardBody}>
        ...
        <div className={styles.cardFooter}>
          ...
          <div className={styles.acciones}>
            ...
            {/* ← Aquí estaba el bug: faltaba onClick */}
            <button
              type="button"
